...
<head>
	...
	<link href="<?php echo base_url();?>assets/stylesheets/cms.css" rel="stylesheet" type="text/css">
	<link href="<?php echo base_url();?>assets/stylesheets/cms-common.css" rel="stylesheet" type="text/css">
...
<div id="wrapper">
	<header id="main_header" class="clearfix">
    	<div id="topbar">
        	<nav>
            	<a class="home" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/topbar-home.png" alt="" /><span>Home</span></a></li>
	...
	<div id="main">
		...
		<div id="sidebar">
			...
			<div id="sidebar_content" class="clearfix">
				...
				<div class="coc"> Click <a href="/en-gb/community/conduct">here</a> to view the Forums Code of Conduct.</div>
				<br />
			</div>
		</div>
