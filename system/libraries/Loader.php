...
class CI_Loader {
	...
	private $_ci_view_path		= '';
	private $_ci_is_php5		= FALSE;
	private $_ci_is_instance 	= FALSE; // Whether we should use $this or $CI =& get_instance()
	private $_ci_cached_vars	= array();
	private $_ci_classes		= array();
	private $_ci_loaded_files	= array();
	private $_ci_models			= array();
	private $_ci_helpers		= array();
	private $_ci_plugins		= array();
	private $_ci_varmap			= array('unit_test' => 'unit', 'user_agent' => 'agent');
    
    // MY own additions to the framework
    private $_TableToDbList;
	...
	{	
        ...
        include_once(BASEPATH.'database/db_store'.EXT);
        $this->dbStore = new DB_Store($this);
	}
	 ...
	 * @return	void
	 */
	private function _ci_load($_ci_data)
	{
	 ...
	 * @return 	void
	 */
	private function _ci_load_class($class, $params = NULL, $object_name = NULL)
	{	
	 ...
	 * @return	null
	 */
	private function _ci_init_class($class, $prefix = '', $config = FALSE, $object_name = NULL)
	{	
	 ...
	 * @return	array
	 */
	private function _ci_object_to_array($object)
	{
	 ...
	 * @return	bool
	 */
	private function _ci_is_instance()
	{
